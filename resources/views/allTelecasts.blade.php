    ...
    <div class="main-container">
        ...
        <div class="row">
            <div class="col-md-8" style = "margin-left: 150px;">
                <form action="{{ url('findTelecasts') }}">
                    <table style="border: 0px;">
                        <tr style="border: 0px;">
                            <td style="border: 0px;">
                                <h4>ФИО режиссера или ведущего:</h4>
                            ...
                            <table>
                                ...
                                @foreach($channel as $teleprogramm)
                                    <tr>
                                        ...
                                        <td>
                                            <h4>{{$teleprogramm->category}}:   {{$teleprogramm->name}}</h4>
                                        </td>
                                        <td>
                                            <h4>{{$teleprogramm->age_rating}}</h4>
                                        </td>
                                    </tr>
                                @foreach($teleprogramm->staff as $item)
                                    @foreach($item as $position => $FIO)
                                        <tr>
                                            <td>
